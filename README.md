...
For testing using [DotNetLib.tlb](DotNetLib.tlb type library](https://github.com/MarkJohnstoneGitHub/VBA-DotNetLib/tree/main/COMDotNetLib/bin/Release) for the COM object selected DateTime 
