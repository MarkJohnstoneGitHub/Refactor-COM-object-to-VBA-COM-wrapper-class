...
namespace ComRefactor.ComManagement.TypeLibs
{
    ...
    internal sealed class TypeInfoInternalWrapper : TypeInfoInternalSelfMarshalForwarderBase , ITypeInfoInternalWrapper
    {
        private DisposableList<ITypeInfoInternalWrapper> _cachedReferencedTypeInfos;
        ...
        public ComTypes.TYPEKIND TypeKind => (ComTypes.TYPEKIND)CachedAttributes.typekind;
        ...
        /// <summary>
        /// Constructor -- should be called via <see cref="InternalTypeApiFactory"/> only.
        /// </summary>
        ...
        internal TypeInfoInternalWrapper(ComTypes.ITypeInfo rawTypeInfo)
        {
            if ((rawTypeInfo as TypeInfoInternalSelfMarshalForwarderBase) != null)
            {
                ...
                var tlib = (TypeInfoInternalWrapper)(TypeInfoInternalSelfMarshalForwarderBase)rawTypeInfo;
        ...
        internal TypeInfoInternalWrapper(IntPtr rawObjectPtr, int? parentUserFormUniqueId = null)
        {
        ...
        // TODO remove??
        public int GetSafeRefTypeInfo(int hRef, out ITypeInfoInternalWrapper outTI)
        {
            outTI = null;
