...
namespace ComRefactor.ComManagement.TypeLibs
{
    ...
    /// </summary>
    internal class TypeInfoInternalImplementedInterfacesCollection : IndexedCollectionBase<ITypeInfoInternalWrapper>, ITypeInfoInternalImplementedInterfacesCollection
    {
        private readonly ComTypes.ITypeInfo _parent;
        private readonly int _count;
        public TypeInfoInternalImplementedInterfacesCollection(ComTypes.ITypeInfo parent, ComTypes.TYPEATTR attributes)
        {
            _parent = parent;
        ...
        public override ITypeInfoInternalWrapper GetItemByIndex(int index)
        {
            ...
            return InternalTypeApiFactory.GetTypeInfoInternalWrapper(ti);
        }
